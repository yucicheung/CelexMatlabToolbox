function []=saveDenoisedGrayComparison(events,eventDelta,saveDir)
%function [] = saveDenoisedGrayComparison( events,eventDelta,saveDir )
%
% Save concatenated pic of the gray pic and its denoised-version pic 
% under the floder 'denoisedGrayComparison' in specified directory 'saveDir'.
% 
% Takes in:
%     'events'
...
narginchk(3,3);
saveDir=fullfile(saveDir,'denoisedGrayComparison');
dirChk(saveDir)
...
fprintf('Start saving DenoisedGrayComparison images...\n')
...
fprintf('Finished saving DenoisedGrayComparison images.\n')
end
